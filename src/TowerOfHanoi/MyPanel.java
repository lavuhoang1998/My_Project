...
public class MyPanel extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		g.fillRect(POLE1CENTER - (POLEWIDTH / 2), (POLEBASE - POLEHEIGHT),POLEWIDTH, POLEHEIGHT);  	//Draw pole 1
		g.fillRect(POLE2CENTER - (POLEWIDTH / 2), (POLEBASE - POLEHEIGHT),POLEWIDTH, POLEHEIGHT);	//Draw pole 2
		g.fillRect(POLE3CENTER - (POLEWIDTH / 2), (POLEBASE - POLEHEIGHT),POLEWIDTH, POLEHEIGHT);	//Draw pole 3
		g.fillRect(5, POLEBASE, 585, POLEWIDTH);													//Draw pole base
